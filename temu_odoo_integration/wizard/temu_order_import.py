    ...
    def action_import_orders(self):
        ...
        for order_data in mock_orders:
            ...
            sale_order_vals = {
                ...
                'is_temu_order': True,
                'team_id': self.connector_id.team_id.id if self.connector_id.team_id else (self.env.ref('temu_odoo_integration.sales_team_temu', raise_if_not_found=False) or self.env['crm.team']).id,
